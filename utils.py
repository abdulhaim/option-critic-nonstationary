...
class Critic():
    ...
    def update_Qs(self, state, option, action, reward, done, terminations, total_steps, episode, past_episodes, log, args, tb_writer):
        ...
        if(total_steps%10 == 0 and total_steps!=0):
            ...
            tb_writer.add_scalars("target", {"target": target}, past_episodes+episode)
